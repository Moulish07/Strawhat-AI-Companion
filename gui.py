...
# --- 2. THE MAIN WINDOW ---
root = ctk.CTk()
root.title("LUFFY Neural Interface")
...
# Holographic Title
title_label = ctk.CTkLabel(master=frame, text="LUFFY", font=("Roboto", 45, "bold"), text_color="#00FFFF")
title_label.pack(pady=(30, 5))

# Tech Subtitle
status_label = ctk.CTkLabel(master=frame, text="A.I. SYSTEM ONLINE", font=("Consolas", 14), text_color="#00AAFF")
status_label.pack(pady=(0, 20))

# The Modern Output Terminal
log_area = ctk.CTkTextbox(master=frame, width=500, height=450, corner_radius=10, 
                          fg_color="#050505", text_color="#00FF00", font=("Consolas", 13))
